...
public class GcDemo {
    private static final Logger LOG = Logger.getLogger(GcDemo.class);
    // LOG.debug("TransactionManagerImpl constructor");
    public static void main(String... args) throws Exception {
    //    System.out.println("Starting pid: " + ManagementFactory.getRuntimeMXBean().getName());
        LOG.debug("Starting pid: " + ManagementFactory.getRuntimeMXBean().getName());
        switchOnMonitoring();
    ...
    private static void switchOnMonitoring() {
        ...
        for (GarbageCollectorMXBean gcbean : gcbeans) {
           // System.out.println("GC name:" + gcbean.getName());
            LOG.debug("GC name:" + gcbean.getName());
...
//                            ", gcCause:" + gcCause + "(" + duration + " ms)");
                    LOG.debug("start:" + startTime + " Name:" + gcName + ", action:" + gcAction +
                            ", gcCause:" + gcCause + "(" + duration + " ms)");
                }
            };
